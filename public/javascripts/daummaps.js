// 각 지점별 위경도 정보
var storeNmArr = ["루스트 노형점", "베라체점", "제원점", "삼화점", "서귀포점", "시청점", "외도점", "칠성점", "아라점"];
var wLatArr = [33.4838730, 33.4924271, 33.4855807, 33.514457, 33.2535815, 33.4989411, 33.4856155, 33.5149974, 33.4740497];
var lLatArr = [126.469922, 126.5429524, 126.4928116, 126.5754184, 126.5072841, 126.5298713, 126.4306835, 126.5253870, 126.5451381];
...
function renderDaumMap(mapIdx) {
    ...
    */ 
    ...
    //var imageSrc = 'http://psw7194.iptime.org/images/map/marker_roost.png', // 마커이미지의 주소입니다    
    var imageSrc = 'http://www.roostplace.com/images/map/marker_roost.png', // 마커이미지의 주소입니다    
